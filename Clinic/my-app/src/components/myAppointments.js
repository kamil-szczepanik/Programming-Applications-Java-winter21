                ...
                <div>
                    ...
                    appointment=>{
                        ...
                        <>
                            ...
                            <p className = "appointment" key={"spec"+appointment.id}> Specializacja: {docSpecialisation}</p>
                            <p className = "appointment" key={appointment.id+1000}> Data wizyty: {appointment.date.toString().slice(0,10)+" "+appointment.date.toString().slice(11,16)}</p>
                            <br></br>
                        </>)
